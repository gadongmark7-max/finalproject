...
app.get('/addField', async (request: Request, response: Response) => {
  ...
  const dates = ["4/13/2026", "4/14/2026", "4/15/2026", "4/16/2026", "4/17/2026", "4/18/2026"];

  const transactions = await transactionsModel.find({ date: { $exists: true } });
