    ...
    <div className="w-full h-dvh bg-primary flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-lg">
        ...
        <div className="anim-up-1 flex items-center gap-3 mb-5">
          ...
          <span className="text-[10px] uppercase tracking-[0.28em] text-gold">Subscription Expired</span>
          <div className="h-px w-8 bg-gold" />
        </div>
        ...
        <p className="anim-up-3 text-text-muted text-sm leading-relaxed max-w-xs mb-8">
          This feature is locked because your subscription has expired. Avail a plan to instantly restore full access — your data is safe and waiting.
        </p>

        {/* Divider */}
        <div className="anim-up-4 flex items-center gap-4 mb-8 w-full max-w-xs">
          <div className="flex-1 h-px bg-border" />
          <span className="text-[9px] uppercase tracking-[0.28em] text-text-dim">renew to unlock</span>
          <div className="flex-1 h-px bg-border" />
        </div>
        ...
        <div className="anim-up-5 w-full max-w-xs space-y-4">
          <div className="relative">
            ...
            <div className="p-3">
              <Button
                onClick={() => router.push("/pages/bussiness/subscription")}
                className="w-full"
              >
          ...
          <p className="text-[10px] uppercase tracking-[0.18em] text-text-dim">
            No hidden fees &nbsp;·&nbsp; Cancel anytime &nbsp;·&nbsp; ₱150/day
          </p>
        </div>
