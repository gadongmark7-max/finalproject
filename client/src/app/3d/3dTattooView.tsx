...
export function ViewTattoo3DModal({
  ...
  const focusOnTattoo = () => {
    if (!tattooDataRef.current || !cameraRef.current || !controlsRef.current)
      return;
  ...
  const recreateDecal = () => {
    ...
    const { mesh, point, orientation, localRotation, localScale } =
      tattooDataRef.current;
    ...
    <div className="overflow-hidden ">
      ...
      >
        <div className="relative w-full h-screen bg-primary">
          ...
          <div
            className={`absolute top-16 lg:top-0 left-0 h-[calc(100%-4rem)] lg:h-full w-full sm:w-80 bg-secondary border-r border-border flex-col overflow-auto z-20
            ...
            <div className="flex flex-col gap-4 p-6">
              ...
              <div className="bg-surface border border-border p-5">
                <p className="text-[10px] uppercase tracking-[0.2em] text-gold mb-4 flex items-center gap-2">
                  <span className="h-px w-4 bg-gold inline-block" /> Rotate
                  Around
                </p>
          ...
          <div
            className={`absolute top-16 lg:top-0 right-0 h-[calc(100%-4rem)] lg:h-full w-full sm:w-80 bg-secondary border-l border-border flex-col overflow-auto z-20
          ...
          >
            ...
            <div className="flex flex-col gap-5 p-6 flex-1">
              ...
              <div className="border-t border-border pt-4 space-y-3">
                <div>
                  <p className="text-[9px] uppercase tracking-[0.18em] text-text-muted mb-0.5">
                    Date
                  </p>
