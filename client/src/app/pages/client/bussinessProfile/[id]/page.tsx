...
import { MessageCircle, Skull, Star, MapPin, Layers, ChevronRight, Users, CalendarDays } from "lucide-react";
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <ReportButton reportedAccount={bussinessInfo.bussiness._id} />
              </div>
            </div>
        ...
        {selectedArtist && (
          <div className="mb-12 border-b border-border pb-12">
            ...
            <div className="flex items-center gap-4 mb-6 bg-surface border border-border p-4">
              <div className="relative flex-shrink-0">
                <Link href={`/pages/client/artistProfile/${selectedArtist.artist._id}`}>
