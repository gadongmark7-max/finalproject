...
export function EditSchedule({ employee, currentDays, CurrentTime, hrs , currentSalary, currentSalaryType}: { employee: accountInterface ,  currentDays  : string[], CurrentTime : string[], hrs  : number,currentSalary : number, currentSalaryType : string}) {
  ...
  const uploadMutation = useMutation({
    mutationFn: (data: { id: string; day: string[]; time: string[], type : string,  salary : number, salaryType : string}) =>
