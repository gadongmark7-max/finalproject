...
export default function Page() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      Swal.fire({
        title: "Post Removed",
        text: "This post was removed from your active listings and you will be redirected to your posts.",
        icon: "success",
      }).then(() => router.push("/pages/artist/myPost"));
    },
  ...
  const handleDelete = () => {
    confirmAlert(
      "This post will be removed from your active listings. It won't be permanently deleted.",
      "Delete Post",
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            {/* Image */}
            <div className="relative border border-border overflow-hidden h-[320px] sm:h-[420px] lg:h-[560px] bg-surface">
