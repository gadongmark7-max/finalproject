...
export function WorkModal({
  ...
  work: worksInterface;
  setWorks: (works: worksInterface[]) => void;
}) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          className="absolute items-center gap-2 w-full h-full opacity-0 "
          ...
          <div className="flex justify-around  p-2 mt-10">
            ...
            <Link href={`/pages/artist/addPost/${work._id}`}>
              <div className="relative group">
                ...
                <span className="absolute -top-6 left-1/2 transform -translate-x-1/2  text-gray-400 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                  Post
                </span>
              </div>
            </Link>
