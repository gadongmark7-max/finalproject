...
export default function ToPayBookings({
  bookings,
  setBookings,
}: {
    ...
    return (
      <div className="relative border border-border bg-surface p-16 text-center">
        ...
        <p className="text-text-muted text-sm">
          Bookings will appear here while they&apos;re awaiting payment from
          the client
        </p>
      </div>
    );
      ...
      {bookings.map((booking) => (
        ...
        >
          ...
          <div className="flex items-center justify-between gap-3 px-5 py-4 border-b border-border">
            ...
            {/* Status Badge */}
            <span className="flex-shrink-0 text-[9px] uppercase tracking-[0.15em] px-2.5 py-1 bg-warning-muted text-warning-light border border-warning-border">
              {booking.status}
            </span>
          </div>
            ...
            <div className="flex-1 space-y-3 min-w-0">
              ...
              <div className="flex justify-between">
                <p className="text-[9px] uppercase tracking-[0.18em] text-text-muted flex items-center gap-1.5">
                  <PhilippinePeso className="w-3 h-3 text-gold" /> Amount Due
                </p>
                <p
          ...
          {/* Card Footer — Actions */}
          <div className="flex flex-wrap items-center gap-2 px-5 py-4 border-t border-border mt-auto">
            {booking.paymentMethod === "counter" ? (
              ...
              <p className="text-[10px] uppercase tracking-[0.15em] text-text-muted flex items-center gap-1.5">
                <Hourglass className="w-3 h-3 text-gold" /> Waiting for the
                client&apos;s online payment
              </p>
            )}
