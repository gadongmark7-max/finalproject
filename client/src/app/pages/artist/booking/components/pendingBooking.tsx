      ...
      {bookings.map((booking) => (
        ...
        >
          ...
          <div className="flex items-center justify-between gap-3 px-5 py-4 border-b border-border">
            ...
            {/* Status Badge */}
            <span
              className={`flex-shrink-0 text-[9px] uppercase tracking-[0.15em] px-2.5 py-1 ${statusStyle[booking.status] ?? "border border-border text-text-muted"}`}
            >
              {booking.status}
            </span>
          </div>
          ...
          <div className="flex gap-4 p-5">
            ...
            <div className="flex-1 space-y-3 min-w-0">
              ...
              <div className="flex items-center justify-between gap-3">
                <p className="flex shrink-0 items-center gap-1.5 text-[9px] uppercase tracking-[0.18em] text-text-muted">
                  <Wallet className="h-3 w-3 shrink-0 text-gold" />
                  Payment
                </p>
